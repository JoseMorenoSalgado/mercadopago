...
/**
 * Library file for the MercadoPago Checkout Pro enrolment plugin.
 *
...
class enrol_mpcheckoutpro_plugin extends enrol_plugin {
    ...
    public function get_currencies() {
        // Updated to include all supported currencies, matching settings.php
        $codes = array(
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        if (abs($cost) < 0.01) {
            ...
            echo '<p>' . get_string('nocost', 'enrol_mpcheckoutpro') . '</p>';
        } else {
